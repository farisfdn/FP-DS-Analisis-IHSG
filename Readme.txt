...
1. Membangun proxy index IHSG (market-cap weighted) dan membandingkan
   pergerakannya di 3 timeframe: daily, hourly, minute.
2. Menghitung & memvisualisasikan performa rata-rata tiap sektor di 3
   jendela waktu (7 / 30 / 90 hari bursa terakhir).
3. Melatih model Machine Learning (scikit-learn) untuk memprediksi arah
   index IHSG besok (naik/turun), berdasarkan indikator teknikal (SMA,
   MACD, RSI, Bollinger %B, momentum, volume relatif) dari index proxy
   itu sendiri.
